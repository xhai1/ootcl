...
<div class="mapper">
    ...
    <!--控制开关-->
    <div class="floatleft control hidden ">
...
<div class="rightstylercus  floatleft maxdis" >
        
        <div class="timerecordtitle">计费标准</div>
        ...
        <div class="floatright">
            ...
            <form method="post" name="main" action="${pageContext.request.contextPath}/moneyStandard/searchCusStandard.action">
        		    ...
        		    公司：
                <input name="cusname" type="text" maxlength="80" value="${customersea.cusname}" />
                <input name="" type="submit" value="查询" class="dis" /> 
                <input name="" type="button" value="修改" class="dis" onclick="save()"/> 
                <input name="" type="button" value="初始化导入" class="dis"  onclick="firstImort()"/>
                <input name="" type="button" value="横向导入" class="dis hidden" />
                <input name="" type="button" value="数字转换" class="dis hidden" />
