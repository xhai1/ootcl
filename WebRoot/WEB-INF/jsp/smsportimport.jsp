...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function download(){
			window.location.href="${pageContext.request.contextPath}/download/downloadMessage.action"
		}
	</script>
...
<body style="color">
  <div class="grayStripe">短信端口归属导入</div>
<div class="addclass">

<form action="${pageContext.request.contextPath}/SmsPort/importSmsPort.action" method="post" enctype="multipart/form-data" name="form1" onsubmit="return checkM(form1)">
<table>
    <tr>
