...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function download(){
			window.location.href="${pageContext.request.contextPath}/download/download981.action"
		}
	</script>
...
<body style="color">
  <div class="grayStripe">多媒体租户分机号导入</div>
<div class="addclass">

<form action="${pageContext.request.contextPath}/multi981/importMultiMedia981.action" method="post" enctype="multipart/form-data" name="form1" onsubmit="return checkM(form1)">
<table>
    <tr>
