...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function download(){
			window.location.href="${pageContext.request.contextPath}/download/downloadHotLine.action"
		}
	</script>
...
<body style="color">
 <div class="grayStripe">热线号落地号导入</div>
<div class="addclass">

<form action="${pageContext.request.contextPath}/hotline/importHotLine.action" method="post" enctype="multipart/form-data" name="form1" onsubmit="return checkM(form1)">
<table>
    <tr>
